...
public class ExcelUtils {
    ...
    public static int generateExcel(ExcelData excelData, String path) throws IOException {
        File f = new File(path);
        FileOutputStream out = new FileOutputStream(f);
        return exportExcel(excelData, out);
    }

    private static int exportExcel(ExcelData data, OutputStream out) throws IOException {
